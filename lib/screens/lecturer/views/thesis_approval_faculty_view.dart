...
class ThesisApprovalFacultyView extends StatefulWidget {
  const ThesisApprovalFacultyView({super.key});

  @override
  State<ThesisApprovalFacultyView> createState() => _ThesisApprovalFacultyViewState();
}

class _ThesisApprovalFacultyViewState extends State<ThesisApprovalFacultyView>
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      context.read<ThesisApprovalBloc>().add(
        const LoadThesesForApproval(ApprovalType.faculty),
      );
    });
  ...
  void _showBatchApprovalDialog() {
    ...
    showDialog(
      ...
      builder: (dialogContext) => AlertDialog(
        title: const Text('Duyệt hàng loạt cấp khoa'),
            ...
            onPressed: () {
              ...
              bloc.add(
                BatchApproveTheses(
                  ...
                  newStatus: ThesisStatus.facultyApproved,
                ),
              );
              _toggleSelectMode();
            },
        ...
        children: [
                    ...
                    Expanded(
                      child: DropdownButtonFormField<String>(
                        ...
                        items: [
                          ...
                          const DropdownMenuItem(
                            value: 'Đã duyệt cấp khoa',
                            child: Text('Đã duyệt cấp khoa'),
                          ),
                        ],
          ...
          Expanded(
            child: BlocBuilder<ThesisApprovalBloc, ThesisApprovalState>(
              builder: (context, state) {
                if (state is ThesisApprovalLoading || state is ThesisApprovalProcessing) {
                  return const LoadingIndicator(message: 'Đang tải danh sách đề tài...');
                }
                    ...
                    return Center(
                      child: Column(
                        ...
                        children: [
                          ...
                          const SizedBox(height: 16),
                          Text(
                            'Không có đề tài nào cần duyệt cấp khoa',
                            style: TextStyle(
                              fontSize: 18,
